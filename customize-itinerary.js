...
const CHIP_CONFIG = {
  ...
  'steak': { textQuery: 'steakhouse OR chophouse OR nyama choma', includedType: 'restaurant', viewportAware: true, debounceMs: 600, sortBy: 'score', minRating: 4.2, minReviewCount: 50, resultCap: 20, allowPagination: true, search(signal) { return runTextSearchChip(this, signal); } },
